...
and then you will see your password in the command line''')
        ...
        self.finish_button.place(relx=0.172, rely=0.88, height=44, width=131)
        ...
        self.return_button.place(relx=0.631, rely=0.88, height=44, width=127)
        ...
        self.error_label.place(relx=0.115, rely=0.82, height=20, width=150)
        self.error_label.configure(background="#d5c0fa")
        self.error_label.configure(disabledforeground="#a3a3a3")
        self.error_label.configure(font=font13)
